---
name: webinar-script
description: "Use when the user asks for 'webinar script', 'webinar', 'live presentation', 'teach-to-sell', or needs a timestamped presentation script with slide notes, presenter cues, and replay email sequence. Do not use for launch plans or static sales page copy."
---
...
> **Original source:** `cwinvestments/memstack/skills/marketing/webinar-script/SKILL.md`.
