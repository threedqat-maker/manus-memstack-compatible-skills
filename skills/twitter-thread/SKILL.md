---
name: twitter-thread
description: "Use when the user asks for 'twitter thread', 'tweet thread', 'X thread', 'viral thread', or wants to create a multi-tweet narrative with hook tweets, data points, and CTAs. Do not use for TikTok scripts, newsletters, or LinkedIn posts."
---
...
> **Original source:** `cwinvestments/memstack/skills/content/twitter-thread/SKILL.md`.
