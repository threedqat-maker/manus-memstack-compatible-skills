---
name: tiktok-script
description: "Use when the user asks for 'TikTok script', 'TikTok video', 'Reels script', 'Shorts script', 'short-form video', or needs timestamped scripts with hooks, visual cues, and captions for 15-60 second videos. Do not use for Twitter threads or webinar scripts."
---
...
> **Original source:** `cwinvestments/memstack/skills/content/tiktok-script/SKILL.md`.
