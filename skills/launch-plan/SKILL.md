---
name: launch-plan
description: "Use when the user asks for 'launch plan', 'product launch', 'go-to-market', 'launch calendar', or needs a day-by-day launch timeline with pre-launch, launch week, and post-launch task checklists. Do not use for ongoing funnel design or ad copy alone."
---
...
> **Original source:** `cwinvestments/memstack/skills/marketing/launch-plan/SKILL.md`.
...
### Step 1: Gather Launch Requirements
...
### Step 3: Pre-Launch Phase (T-minus 4 to 1 weeks)
...
| T-26 | Set up email sequences (pre-launch + launch) | Email | Marketing |
...
| 7:00 AM | Send launch email to full list | Email |
...
| Day | Task | Channel |
|-----|------|---------|
| Day 8 | "Thank you" email to buyers + what's next | Email |
| Day 8 | Analyze launch metrics (see Step 7) | Analytics |
| Day 10 | Collect testimonials from early customers | Email |
| Day 14 | Publish launch retrospective blog post | Blog |
| Day 14 | Send re-engagement offer to non-buyers | Email |
...
**Outreach targets:**
- Industry-specific blogs and newsletters (20+)
- Relevant podcast hosts (10+)
- Twitter/X influencers in the space (15+)
- YouTube reviewers (5+)
- Journalists at relevant publications (10+)

### Step 7: Metrics Tracking Dashboard
