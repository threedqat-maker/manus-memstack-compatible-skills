---
name: verify
description: "Use when the user asks for 'verify', 'check this work', 'does it pass', or before committing completed work."
---
...
> **Original source:** `cwinvestments/memstack/skills/verify/SKILL.md`.
