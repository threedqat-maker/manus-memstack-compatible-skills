...
description: "Use when the user asks for 'generate changelog', 'update changelog', 'what changed', 'release notes', 'write changelog', or needs a formatted CHANGELOG.md from git commit history. Do not use for diary entries, git log viewing, or commit message writing."
---
...
> **Original source:** `cwinvestments/memstack/skills/development/changelog-generator/SKILL.md`.
