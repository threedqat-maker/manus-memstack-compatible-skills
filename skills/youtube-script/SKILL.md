---
name: youtube-script
description: "Use when the user asks for 'YouTube script', 'video script', 'write script for YouTube', 'YouTube video outline', or is creating scripted content for a YouTube video with hooks, chapters, and CTAs. Do not use for TikTok/Reels short-form scripts or webinar presentations."
---
...
> **Original source:** `cwinvestments/memstack/skills/content/youtube-script/SKILL.md`.
